...
//--------------------------------------------------------------
ofxIlda::PolyProcessor::PolyProcessor() {
...
//--------------------------------------------------------------
string ofxIlda::PolyProcessor::getString() {
    stringstream s;
...
//--------------------------------------------------------------
void ofxIlda::PolyProcessor::update(const vector<Poly> &origPolys, vector<Poly> &processedPolys) {
    float totalLength = 0;
